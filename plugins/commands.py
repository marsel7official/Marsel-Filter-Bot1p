...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton("➕️ ADD YOU GROUP ➕️", url=f"http://t.me/{temp.U_NAME}?startgroup=true")
            ],[
            InlineKeyboardButton("🔍 SEARCH🔍", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("📢 Update 📢", url="https://t.me/MarselUpdate")
            ],[      
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            InlineKeyboardButton("➕️ ADD YOUR GROUP  ➕️", url=f"http://t.me/{temp.U_NAME}?startgroup=true")
            ],[
            InlineKeyboardButton("🔍 SEARCH 🔍", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("📢 UPDATE 📢", url="https://t.me/MarselUpdate")
            ],[      
